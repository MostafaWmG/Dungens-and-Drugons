...
/**
 * This is a NimbleFighterBuilder class for creating NimbleFighter
 * @author wmg
 */
public class NimbleFighterBuilder extends FighterBuilder{
	...
	public void setCharacterAbility() {
		...
		System.out.println("<<<Nimble Fighter CREATED RANDOMLY>>> ");
		getFighter().setCharacterAbility();
		getFighter().replaceAbility(new Ability(AbilityEnum.DEXTERITY,numbers.get(numbers.size()-1),(int)Math.floor( (numbers.get(numbers.size()-1) - 10) /2 )));
